...
Finally, if you want me to convert times to your timezone, I can do that provided you tell me what it is. Please use `!listtimezones` to list all the timezones I know about. Then use `!settimezone Central Standard Time` to set your timezone to Central Standard Time, as an example.
...
`!listtimezones` - will list all of the time zones I know about
`!settimezone Central Standard Time` - will set your timezone to Central Standard Time");
        }
    }
}
