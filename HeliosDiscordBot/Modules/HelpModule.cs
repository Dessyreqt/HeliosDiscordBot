...
`!notify sunrise 10` - will start notifying 10 minutes before sunrise
`!notify sunset 30` - will start notifying 30 minutes before sunset
...
`!settimezone (UTC+08:00) Perth` - will set your timezone to W. Australia Standard/Daylight Time");
        }
    }
}
